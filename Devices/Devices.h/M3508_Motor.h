...
#define M3508_CHASSIS_START_ID 0x205 //Starting ID for chassis motors
#define M3508_CHASSIS_END_ID	0x206 //Ending ID for chassis motors
...
#define M3508_FRIC_WHEEL_BOTTOM_ID 0x203 //Right friction wheel motor ID
...
extern Motor_Init_t M3508_Fric_Wheel[3];
